...
public let DISPATCH = DISPATCH_EVENT_LOOP_GROUP.next()
public var LOGGER = Logger(label: "qsib-sensor")
public let FORMATTER = DateFormatter()
public let ENCODER = JSONEncoder()
public let DECODER = JSONDecoder()
public let HTTP_CLIENT = HTTPClient(eventLoopGroupProvider: .shared(EVENT_LOOP_GROUP))
public let QS_LIB = QsibSensorLib()
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        UserDefaults.standard.setValue("", forKey: "ble_name")
